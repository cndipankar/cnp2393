...
class Miscellaneous_Modifications {
    ...
    public function __construct() {        
        ...
        // Change checkout page Place Order button text
        add_filter( 'woocommerce_order_button_text', array( $this, 'change_checkout_order_button_text' ) );  
    ...
    public function change_checkout_order_button_text() {
