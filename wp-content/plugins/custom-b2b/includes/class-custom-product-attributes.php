        ...
        <script>
            jQuery(function($){                
                ...
                function updateIndexes() {
                    $("#cpa_attributes_wrapper .cpa_attribute").each(function (index) {

                        // FIX 1: Required checkbox
                        $(this).find('input[name^="cpa_required"]').attr('name', 'cpa_required[' + index + ']');

                        // FIX 2: Default option radio
                        $(this).find('input[name^="cpa_default_option"]').attr('name', 'cpa_default_option[' + index + ']');

                        // FIX 3: Option label inputs
                        $(this).find('input[name^="cpa_option_label"]').attr('name', 'cpa_option_label[' + index + '][]');

                        // FIX 4: Option value inputs
                        $(this).find('input[name^="cpa_option_value"]').attr('name', 'cpa_option_value[' + index + '][]');

                        // FIX 5: Add button data-index
                        $(this).find('.cpa-add-option').attr('data-index', index);
                ...
                $(document).on("click", ".cpa-add-option", function(e){
                    ...
                    let index = attribute.closest('#cpa_attributes_wrapper')
                     .find('.cpa_attribute')
                     .index(attribute);
