...
<?php if ( $this->has_header_logo() ) : ?>
	<h1 class="document-type-label">Quote Request<?php //$this->title(); ?></h1>
<?php endif; ?>
		...
		<td class="order-data">
			<table>
				...
				<tr class="order-number">
					<th>Quote number<?php //$this->order_number_title(); ?></th>
					<td><?php $this->order_number(); ?></td>
				</tr>
				<tr class="order-date">
					<th>Quote Date<?php //$this->order_date_title(); ?></th>
	...
	<tbody>
		<?php foreach ( $this->get_order_items() as $item_id => $item ) : ?>
			<tr class="<?php echo esc_html( $item['row_class'] ); ?>">
				...
				<!-- <td class="price">0<?php //echo esc_html( $item['order_price'] ); ?></td> -->
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
