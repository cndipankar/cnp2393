...
if (! class_exists('CSF')) {
    ...
    // constants
      ...
      // init action
            ...
            add_action('admin_enqueue_scripts', [ 'CSF', 'add_admin_enqueue_scripts' ], 20);
        }
      ...
      // check for developer mode
            ...
            // cdn styles
            wp_enqueue_style('csf-fa', 'https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css', [], '4.7.0', 'all');

            // framework core styles
            wp_enqueue_style('csf', CSF::include_plugin_url('assets/css/csf'. $min .'.css'), [], '1.0.0', 'all');

            // rtl styles
            if (is_rtl()) {
                wp_enqueue_style('csf-rtl', CSF::include_plugin_url('assets/css/csf-rtl'. $min .'.css'), [], '1.0.0', 'all');
            }

            // framework core scripts
            wp_enqueue_script('csf-plugins', CSF::include_plugin_url('assets/js/csf-plugins'. $min .'.js'), [], '1.0.0', true);
            wp_enqueue_script('csf', CSF::include_plugin_url('assets/js/csf'. $min .'.js'), [ 'csf-plugins' ], '1.0.0', true);
