...
if (! class_exists('CSF_Field_spinner')) {
    class CSF_Field_spinner extends CSF_Fields
    {
        ...
        public function render()
        {
            ...
            echo '<input type="text" name="'. $this->field_name() .'" value="'. $this->value .'"'. $this->field_attributes([ 'class' => 'csf-number' ]) .' data-max="'. $args['max'] .'" data-min="'. $args['min'] .'" data-step="'. $args['step'] .'"/>';
