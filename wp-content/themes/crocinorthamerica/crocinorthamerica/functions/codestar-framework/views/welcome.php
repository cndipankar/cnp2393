...
if (! class_exists('CSF_Welcome')) {
    class CSF_Welcome
    {
        ...
        {
            if (CSF::$premium && (! CSF::is_active_plugin('codestar-framework/codestar-framework.php') || apply_filters('csf_welcome_page', true) === false)) {
                return;
            }
        ...
        {
            add_management_page('Codestar Framework', 'Codestar Framework', 'manage_options', 'csf-welcome', [ &$this, 'add_page_welcome' ]);
        }
