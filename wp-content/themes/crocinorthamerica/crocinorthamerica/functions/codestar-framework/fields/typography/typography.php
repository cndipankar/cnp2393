    ...
    class CSF_Field_typography extends CSF_Fields
    {
        ...
        public function render()
        {
            ...
            if (! empty($args['font_family'])) {
                ...
                echo $this->create_select([ $this->value['font-family'] => $this->value['font-family'] ], 'font-family', esc_html__('Select a font', 'csf'));
                echo '</div>';
            }
            ...
            if (! empty($args['backup_font_family'])) {
                ...
                echo $this->create_select(apply_filters('csf_field_typography_backup_font_family', [
        ...
        public function enqueue()
        {
            if (! wp_style_is('csf-webfont-loader')) {
                ...
                wp_enqueue_script('csf-webfont-loader', 'https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js', [ 'csf' ], '1.6.28', true);

                $webfonts = [];

                $customwebfonts = apply_filters('csf_field_typography_customwebfonts', []);
                ...
                $defaultstyles = apply_filters('csf_field_typography_defaultstyles', [ 'normal', 'italic', '700', '700italic' ]);

                $googlestyles = apply_filters('csf_field_typography_googlestyles', [
                    '100' => 'Thin 100',
                ...
                wp_localize_script('csf', 'csf_typography_json', [
                    'webfonts' => $webfonts,
        ...
        // set style
                ...
                $families = $this->value['font-family'] . str_replace([ 'normal', 'italic' ], [ 'n', 'i' ], $all_styles) . $all_subsets;
