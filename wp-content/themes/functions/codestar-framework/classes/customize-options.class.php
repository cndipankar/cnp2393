...
if (! class_exists('CSF_Customize_Options')) {
    ...
    // constans
        ...
        public function __construct($key, $params)
        {
            ...
            add_action('customize_save_after', [ &$this, 'add_customize_save' ]);
            ...
            if (! empty($this->sections)) {
                ...
                foreach ($sections as $section) {
                    if (! empty($section['subs'])) {
                        ...
                        $wp_customize->add_panel(new WP_Customize_Panel_CSF($wp_customize, $panel_id, [
        ...
        public function add_section($wp_customize, $section_id, $section_args, $panel_id)
        {
            if (! empty($section_args['assign'])) {
                ...
                $wp_customize->add_section(new WP_Customize_Section_CSF($wp_customize, $section_id, [
